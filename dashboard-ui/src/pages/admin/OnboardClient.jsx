...
export default function OnboardClient() {
  ...
  const handleSubmit = async () => {
        try {
          ...
          const response = await fetch('https://pipelabs-dashboard-production.up.railway.app/api/admin/clients/onboard', {
                    method: 'POST',
          ...
          {successMessage && <Alert severity="success" className="alert-box">{successMessage}</Alert>Alert>}
              ...
              <Paper className="form-paper">
                      <Stepper activeStep={activeStep} className="stepper">
                                <Step>
                                            <StepLabel>Client Info</StepLabel>StepLabel>
                                </Step>Step>
                                <Step>
                                            <StepLabel>Token Details</StepLabel>StepLabel>
                                </Step>Step>
                                <Step>
                                            <StepLabel>API Keys</StepLabel>StepLabel>
                                </Step>Step>
                                <Step>
                                            <StepLabel>Review & Submit</StepLabel>StepLabel>
                                </Step>Step>
                      </Stepper>Stepper>
                      ...
                      <Box className="step-content">
                        {activeStep === 0 && (
                      <Box>
                                    <Typography variant="h6" gutterBottom>Client Information</Typography>Typography>
                        ...
                        {activeStep === 1 && (
                      <Box>
                                    <Typography variant="h6" gutterBottom>Token Details</Typography>Typography>
                                    <Grid container spacing={2}>
                                                    <Grid item xs={12} sm={6}>
                                                                      <TextField
                                                                                            fullWidth
                        ...
                        {activeStep === 2 && (
                      <Box>
                                    <Typography variant="h6" gutterBottom>Exchange API Keys</Typography>Typography>
                                                                              ...
                                                                              <Grid container spacing={2}>
                                                                                                    <Grid item xs={12} sm={3}>
                                                                                                                            <FormControl fullWidth>
                                                                                                                                                      <InputLabel>Exchange</InputLabel>InputLabel>
                                                                                                                                                      <Select
                                                                                                                                                                                  ...
                                                                                                                                                                                  >
                                                                                                                                                        {EXCHANGES.map(ex => (
                                                                                                                                                                                                                  <MenuItem key={ex} value={ex}>{ex.toUpperCase()}</MenuItem>MenuItem>
                                                                                                                                                                                                                ))}
                                                                                                                                                        </Select>Select>
                        ...
                        {activeStep === 3 && (
                      <Box>
                                    <Typography variant="h6" gutterBottom>Review Information</Typography>Typography>
                                    <Grid container spacing={2}>
                                                    <Grid item xs={12} sm={6}>
                                                                      <Card>
                                                                                          <CardContent>
                                                                                                                <Typography color="textSecondary" gutterBottom>Client Name</Typography>Typography>
                                                                                                                <Typography variant="h6">{clientInfo.name}</Typography>Typography>
                                                                                                                <Typography color="textSecondary" gutterBottom style={{ marginTop: '10px' }}>Email</Typography>Typography>
                                                                                                                <Typography>{clientInfo.email}</Typography>Typography>
                                                                                                                <Typography color="textSecondary" gutterBottom style={{ marginTop: '10px' }}>Wallet</Typography>Typography>
                                                                                                                <Typography style={{ fontSize: '0.85em', wordBreak: 'break-all' }}>{clientInfo.walletAddress}</Typography>Typography>
                                                                                            </CardContent>CardContent>
                                                                      </Card>Card>
                                                    </Grid>Grid>
                                                    <Grid item xs={12} sm={6}>
                                                                      <Card>
                                                                                          <CardContent>
                                                                                                                <Typography color="textSecondary" gutterBottom>Token Name</Typography>Typography>
                                                                                                                <Typography variant="h6">{tokenInfo.symbol}</Typography>Typography>
                                                                                                                <Typography color="textSecondary" gutterBottom style={{ marginTop: '10px' }}>Address</Typography>Typography>
                                                                                                                <Typography style={{ fontSize: '0.85em', wordBreak: 'break-all' }}>{tokenInfo.contractAddress}</Typography>Typography>
                                                                                                                <Typography color="textSecondary" gutterBottom style={{ marginTop: '10px' }}>APIs Configured</Typography>Typography>
                                                                                                                <Typography>{apiKeys.length} exchange(s)</Typography>Typography>
                                                                                            </CardContent>CardContent>
                                                                      </Card>Card>
                                                    </Grid>Grid>
                                    </Grid>Grid>
